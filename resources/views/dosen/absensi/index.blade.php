            ...
            <div class="col-lg-12">
                 ...
                 <div class="card">
                    <div class="card-header">
                        <strong>Absensi Hari Ini - {{Carbon\Carbon::parse(now())->isoFormat('dddd, DD MMMM YYYY')}} </strong>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>Total Mengajar : {{$total}} Jam </strong>
                    </div>
...
jQuery(document).ready(function($) {
    ...
    $('#absensi-table').DataTable({
        serverSide  : true,
        processing  : true,
        ajax        : '{{route("absensi.dosen.daftar.ajaxDosen")}}',
        columns     : [
